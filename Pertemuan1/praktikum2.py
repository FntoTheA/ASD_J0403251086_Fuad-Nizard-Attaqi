...
#lat 1, baca data dari file data_mahasiswa.txt
...
def ubah_data(data_dict):
    ...
    #error handling jika nilai < 0 atau > 100
...
#lat 5, buat fungsi simpan data ke file
